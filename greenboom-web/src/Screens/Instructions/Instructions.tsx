  ...
  return (
    <DefaultLayout>
      <div className="text-center">
        ...
        {/* YouTube videos slider/carousel below, will apply when backend is connected */}
        ...
        <div className="ml-[15%] mt-24 mb-24">
          ...
          <button className="ml-[20%] flex items-center bg-primaryA rounded-3xl p-2 text-white text-xl px-5 tracking-widest">
