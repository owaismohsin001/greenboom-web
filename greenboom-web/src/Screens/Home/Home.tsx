          ...
          <div className="bg-primaryA rounded-xl md:ml-40 md:mr-28 w-full md:w-[80%]">
            <div className="p-4 md:p-12 md:pl-36 md:pr-24">
              ...
              >
                ...
                flyers, videos, FAQs, and sales tips. You can also order demo
                and sample spill kits to showcase the Green Boom products in
                action for your customers. Not only will you save time by having
                all of the information in one place, but also elevate
                performance, resulting in increased productivity and a more
                personalized and satisfying experience for your valued
                customers.
              </Title>
            </div>
